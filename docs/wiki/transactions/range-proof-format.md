...
Mugle uses [Bulletproofs](https://eprint.iacr.org/2017/1066.pdf), the currently most efficient range proofs which do not require a trusted setup. Implemented at [mimblewimble/secp256k1-zkp](https://github.com/mugleproject/secp256k1-zkp), a fork of the Blockstream C library [ElementsProject/secp256k1-zkp](https://github.com/ElementsProject/secp256k1-zkp).
