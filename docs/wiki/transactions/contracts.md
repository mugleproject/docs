...
> *Read this in other languages: [简体中文](https://github.com/mugleproject/mugle/blob/master/doc/translations/contracts_ZH-CN.md)*
...
document or the Mugle developers. Most of the credit should be attributed
...
See [No Recent Duplicate (NRD) transaction kernels](https://github.com/mugleproject/mugle-rfcs/blob/master/text/0013-nrd-kernels.md) for more details.
